	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			{ -- Autocompletion
				...
				-- vim.api.nvim_create_augroup('PythonSpecificSettings', { clear = true })

				-- vim.api.nvim_create_autocmd('FileType', {
					--   group = 'PythonSpecificSettings',
					--   pattern = 'python',
					--   callback = function()
						--     vim.opt_local.makeprg = 'make'
						--     vim.opt_local.errorformat = {}
						--     vim.opt_local.errorformat:append {
							--       '%f:%l: %m', -- pytest: path/to/your/test_file.py:10: AssertionError
							--       '%f:%l', -- pytest: path/to/your/test_file.py:10
							--     }
							--
							--     print 'Python errorformat set for current buffer.'
							--   end,
							-- })
